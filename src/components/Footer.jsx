      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-2xl font-bold text-gray-900">PhishDetect</span>
            </div>
            <p className="text-gray-600 max-w-md mb-6">
              Advanced cybersecurity solutions to protect your business from phishing attacks and other digital threats.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Email Protection</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Web Filtering</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Employee Training</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Threat Intelligence</a></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © 2025 PhishDetect. All rights reserved.
          </p>
